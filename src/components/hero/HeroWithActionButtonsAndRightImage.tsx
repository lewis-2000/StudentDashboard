...
function HeroWithActionButtonsAndRightImage() {
    return (
        <div className="relative pt-48 pb-12 bg-black xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56">
            ...
            <div className="absolute inset-0">
                <img className="object-cover w-full h-full" src="https://cdn.rareblocks.xyz/collection/bakerstreet/images/hero/3/background.png" alt="" />
            </div>
...
export default HeroWithActionButtonsAndRightImage